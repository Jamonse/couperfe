...
import { CUSTOMER_DELETE_URL, CUSTOMER_GET_ALL_URL, CUSTOMER_GET_PAGED_SORTED_URL, CUSTOMER_GET_PAGED_URL, CUSTOMER_GET_URL, CUSTOMER_POST_URL, CUSTOMER_PUT_URL } from '../../utils/api.utils';
...
export class CustomersService {
  ...
  {
    return this.httpClient.get<Customer>(CUSTOMER_GET_URL);
  }
